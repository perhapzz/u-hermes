...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_messaging_gateway_title: 'Messaging Gateway',
    settings_section_messaging_gateway_meta: 'Configure Feishu / personal Weixin connection parameters. After saving, restart the Gateway for changes to take effect: close the Start window, make sure background python.exe processes have exited, then double-click Windows-Start.bat or Mac-Start.command again.',
    settings_msggw_weixin_title: 'WeChat (Tencent iLink bot)',
    settings_msggw_weixin_meta: 'Scan to log in on the Tencent iLink platform. Credentials are saved automatically to WEIXIN_TOKEN / WEIXIN_ACCOUNT_ID / WEIXIN_BASE_URL. Note: this provisions an independent bot account, not your personal WeChat ID — no ban risk, but capabilities are limited by Tencent\u2019s API.',
    settings_msggw_weixin_qrlogin_btn: 'Scan to log in',
    settings_msggw_weixin_qr_help: '\u2460 Scan the QR code with your personal WeChat<br>\u2461 Tap \u201cConfirm login\u201d on your phone to authorize the iLink bot<br>\u2462 Credentials are written to .env; restart the Gateway to take effect',
    settings_msggw_weixin_allowed_users_label: 'Allowed users (WEIXIN_ALLOWED_USERS, comma-separated)',
    settings_section_system_meta: 'Instance version and access controls.',
    settings_update_from_gitee: 'Update from Gitee',
    settings_update_from_gitee_running: 'Updating…',
    settings_update_from_gitee_confirm: 'Download the latest U-Hermes from Gitee and overwrite the current files? You will need to relaunch after this finishes.',
    settings_update_from_gitee_restart: 'Update downloaded. Please close this window and re-launch U-Hermes to apply.',
    update_available_title: 'Update available',
    update_available_body: 'A new version of U-Hermes is available on Gitee ({remote} ← {local}, branch {branch}). Update now or skip this version?',
    update_available_update_now: 'Update now',
    update_available_skip_version: 'Skip this version',
    update_available_later: 'Remind me later',
    update_available_skipped_toast: 'Version {sha} will be ignored until a newer one appears.',
    ...
    onboarding_step_workspace_desc: 'Pick the default workspace for new sessions and chat.',
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    settings_section_messaging_gateway_title: 'Gateway di messaggistica',
    settings_section_messaging_gateway_meta: 'Configura i parametri di accesso per Feishu / WeChat personale. Dopo il salvataggio riavvia il Gateway: chiudi la finestra Start, assicurati che i processi python.exe in background siano usciti, poi fai doppio clic di nuovo su Windows-Start.bat o Mac-Start.command.',
    ...
    onboarding_step_workspace_title: 'Workspace',
    onboarding_step_workspace_desc: 'Scegli lo spazio di lavoro predefinito per nuove sessioni e chat.',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_section_messaging_gateway_title: 'メッセージング ゲートウェイ',
    settings_section_messaging_gateway_meta: 'Feishu / 個人版 WeChat の接続パラメータを設定します。保存後は Gateway の再起動が必要です：Start ウィンドウを閉じ、バックグラウンドの python.exe が終了したことを確認してから、Windows-Start.bat または Mac-Start.command を再度ダブルクリックしてください。',
    ...
    onboarding_step_workspace_title: 'ワークスペース',
    onboarding_step_workspace_desc: '新規セッションとチャットのデフォルトワークスペースを選択します。',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    onboarding_step_workspace_title: 'Рабочее пространство',
    onboarding_step_workspace_desc: 'Выберите рабочее пространство по умолчанию для новых сеансов и чатов.',
    ...
    settings_section_system_title: 'System',
    settings_section_messaging_gateway_title: 'Шлюз сообщений',
    settings_section_messaging_gateway_meta: 'Настройка параметров подключения Feishu / личного WeChat. После сохранения перезапустите Gateway: закройте окно Start, убедитесь, что фоновые процессы python.exe завершены, затем снова дважды щёлкните Windows-Start.bat или Mac-Start.command.',
    settings_tab_appearance: 'Appearance',
    settings_tab_conversation: 'Conversation',
    settings_tab_preferences: 'Preferences',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    onboarding_step_workspace_title: 'Espacio de trabajo',
    onboarding_step_workspace_desc: 'Elige el espacio de trabajo predeterminado para nuevas sesiones y chats.',
    ...
    settings_section_system_title: 'System',
    settings_section_messaging_gateway_title: 'Pasarela de mensajería',
    settings_section_messaging_gateway_meta: 'Configura los parámetros de conexión de Feishu / WeChat personal. Tras guardar, reinicia el Gateway: cierra la ventana Start, comprueba que los procesos python.exe en segundo plano han salido y vuelve a hacer doble clic en Windows-Start.bat o Mac-Start.command.',
    settings_tab_appearance: 'Appearance',
    settings_tab_conversation: 'Conversation',
    settings_tab_preferences: 'Preferences',
    settings_tab_plugins: 'Plugins',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_section_system_title: 'System',
    settings_section_messaging_gateway_title: 'Messaging-Gateway',
    settings_section_messaging_gateway_meta: 'Konfigurieren Sie die Verbindungsparameter für Feishu / persönliches WeChat. Nach dem Speichern muss das Gateway neu gestartet werden: Schließen Sie das Start-Fenster, stellen Sie sicher, dass alle python.exe-Hintergrundprozesse beendet sind, und doppelklicken Sie erneut auf Windows-Start.bat oder Mac-Start.command.',
    settings_tab_appearance: 'Appearance',
    settings_tab_conversation: 'Conversation',
    settings_tab_preferences: 'Preferences',
    settings_tab_plugins: 'Plugins',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    onboarding_step_workspace_title: '工作区',
    onboarding_step_workspace_desc: '为新会话和聊天选择默认工作区。',
    ...
    settings_update_from_gitee: '从 Gitee 更新',
    settings_update_from_gitee_running: '更新中…',
    settings_update_from_gitee_confirm: '将从 Gitee 拉取最新的 U-Hermes 代码并覆盖当前文件。完成后需要关闭窗口并重新双击 Windows-Start.bat 或 Mac-Start.command 才能生效，是否继续？',
    settings_update_from_gitee_restart: '更新已下载。请关闭当前窗口并重新双击 Windows-Start.bat 或 Mac-Start.command 以启用新版本。',
    update_available_title: '发现新版本',
    update_available_body: 'U-Hermes 在 Gitee 上有新版本可用（{remote} ← {local}，分支 {branch}）。要立即更新还是跳过这个版本？',
    update_available_update_now: '立即更新',
    update_available_skip_version: '跳过此版本',
    update_available_later: '稍后提醒',
    update_available_skipped_toast: '已忽略版本 {sha}，直到出现更新的版本。',
    ...
    settings_section_messaging_gateway_title: '消息网关',
    settings_section_messaging_gateway_meta: '配置飞书 / 个人微信接入参数。保存后需重启 Gateway 才会生效：关闭 Start 启动窗口、确认后台 python.exe 都退出后，重新双击 Windows-Start.bat 或 Mac-Start.command。',
    settings_msggw_weixin_title: '微信 (腾讯 iLink 小微机器人)',
    settings_msggw_weixin_meta: '扫码登录腾讯 iLink 平台，凭证自动保存到 WEIXIN_TOKEN / WEIXIN_ACCOUNT_ID / WEIXIN_BASE_URL。注意：生成的是机器人独立账号，非个人微信号，无封号风险，但能力受腾讯接口限制。',
    settings_msggw_weixin_qrlogin_btn: '扫码登录',
    settings_msggw_weixin_qr_help: '① 使用个人微信扫描左侧二维码<br>② 在手机上点击「确认登录」授权小微机器人<br>③ 凭证将自动写入 .env，重启 Gateway 后生效',
    settings_msggw_weixin_allowed_users_label: '允许的用户 (WEIXIN_ALLOWED_USERS, 逗号分隔)',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_section_messaging_gateway_title: '訊息閘道',
    settings_section_messaging_gateway_meta: '設定飛書 / 個人微信接入參數。儲存後需重新啟動 Gateway 才會生效：關閉 Start 啟動視窗、確認背景 python.exe 都退出後，重新雙擊 Windows-Start.bat 或 Mac-Start.command。',
    settings_section_system_meta: '實例版本與存取控制。',
    settings_update_from_gitee: '從 Gitee 更新',
    settings_update_from_gitee_running: '更新中…',
    settings_update_from_gitee_confirm: '將從 Gitee 拉取最新的 U-Hermes 程式碼並覆蓋當前檔案。完成後需要關閉視窗並重新雙擊 Windows-Start.bat 或 Mac-Start.command 才會生效，是否繼續？',
    settings_update_from_gitee_restart: '更新已下載。請關閉當前視窗並重新雙擊 Windows-Start.bat 或 Mac-Start.command 以啟用新版本。',
    update_available_title: '發現新版本',
    update_available_body: 'U-Hermes 在 Gitee 上有新版本可用（{remote} ← {local}，分支 {branch}）。要立即更新還是跳過這個版本？',
    update_available_update_now: '立即更新',
    update_available_skip_version: '跳過此版本',
    update_available_later: '稍後提醒',
    update_available_skipped_toast: '已忽略版本 {sha}，直到出現更新的版本。',
    ...
    onboarding_step_workspace_desc: '\u70ba\u65b0\u6703\u8a71\u8207\u804a\u5929\u9078\u64c7\u9810\u8a2d\u5de5\u4f5c\u5340\u3002',
    onboarding_step_workspace_title: '\u5de5\u4f5c\u5340',
  ...
  pt: {
    ...
    settings_section_system_title: 'Sistema',
    settings_section_messaging_gateway_title: 'Gateway de mensagens',
    settings_section_messaging_gateway_meta: 'Configure os parâmetros de conexão do Feishu / WeChat pessoal. Após salvar, reinicie o Gateway: feche a janela Start, confirme que os processos python.exe em segundo plano saíram e clique duas vezes novamente em Windows-Start.bat ou Mac-Start.command.',
    ...
    onboarding_step_workspace_title: 'Workspace',
    onboarding_step_workspace_desc: 'Escolher o workspace padrão para novas sessões e chat.',
  ...
  ko: {
    ...
    settings_section_messaging_gateway_title: '메시징 게이트웨이',
    settings_section_messaging_gateway_meta: 'Feishu / 개인 WeChat 연결 매개변수를 구성합니다. 저장 후에는 Gateway를 다시 시작해야 적용됩니다: Start 창을 닫고 백그라운드 python.exe 프로세스가 모두 종료되었는지 확인한 다음 Windows-Start.bat 또는 Mac-Start.command를 다시 더블 클릭하세요.',
  ...
  fr: {
    ...
    settings_section_messaging_gateway_title: 'Passerelle de messagerie',
    settings_section_messaging_gateway_meta: 'Configurez les paramètres de connexion de Feishu / WeChat personnel. Après sauvegarde, redémarrez la Gateway : fermez la fenêtre Start, vérifiez que les processus python.exe en arrière-plan sont terminés, puis double-cliquez à nouveau sur Windows-Start.bat ou Mac-Start.command.',
    ...
    onboarding_step_workspace_title: 'Espace de travail',
    onboarding_step_workspace_desc: 'Choisissez l’espace de travail par défaut pour les nouvelles sessions et le chat.',
  ...
  tr: {
    ...
    settings_section_messaging_gateway_title: 'Mesajlaşma Ağ Geçidi',
    settings_section_messaging_gateway_meta: 'Feishu / kişisel WeChat bağlantı parametrelerini yapılandırın. Kaydettikten sonra Gateway\'i yeniden başlatın: Start penceresini kapatın, arka plandaki python.exe süreçlerinin sonlandığından emin olun, ardından Windows-Start.bat veya Mac-Start.command dosyasına tekrar çift tıklayın.',
    ...
    onboarding_step_workspace_title: 'Çalışma alanı',
    onboarding_step_workspace_desc: 'Yeni oturumlar ve sohbet için varsayılan çalışma alanını seçin.',
